...
export const projectsData: Project[] = [
    {
        title: "AI-Powered Personalized Fitness Planner",
        description:
        ...
        highlights: [
            ...
            "Integrated with the OpenAI API to create diverse and effective workout routines.",
            "Designed a clean and intuitive UI with TailwindCSS for optimal user experience.",
        ],
    },
    {
        title: "AI-Powered Personalized Fitness Planner",
